...
func TestEvent(t *testing.T) {
	...
	t.Run("Filter", func(t *testing.T) {
		...
		filterData := []struct {
			...
			{Expr: makeJsonFilterExpr(t, []string{"host.vars.dict.domain"}, ">", "eaample.com", false), Expected: true}, // same character len but e[x] > e[a]
			...
			{Expr: makeJsonFilterExpr(t, []string{"host.vars.dict.domain"}, ">", "example.dom", false), Expected: false}, // .com < .dom

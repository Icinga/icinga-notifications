			...
			expected: &ObjectQueriesResult[HostServiceRuntimeAttributes]{
				...
				Attrs: HostServiceRuntimeAttributes{
					...
					LastCheckResult: CheckResult{
						...
						State:          0,
						ExecutionStart: Icinga2Time{time.UnixMicro(1698673636068106)},
						ExecutionEnd:   Icinga2Time{time.UnixMicro(1698673636071483)},
					},
					LastStateChange:           Icinga2Time{time.UnixMicro(1697704135756310)},
					DowntimeDepth:             0,
					Acknowledgement:           0,
					AcknowledgementLastChange: Icinga2Time{time.UnixMicro(0)},
				},

...
CREATE TABLE source (
    ...
    CONSTRAINT uk_source_client_certificate_cn UNIQUE (client_certificate_cn),
    CONSTRAINT ck_source_listener_identity_or_deleted CHECK (deleted = 'y' OR listener_username IS NOT NULL OR client_certificate_cn IS NOT NULL),

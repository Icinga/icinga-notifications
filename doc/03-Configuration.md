...
| Option     | Description                                                                                                                                                                                                        |
|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| period     | **Optional.** Retention period defined as [duration string](#duration-string). Defaults to `0s`. Data older than this period will be automatically deleted from the database.                                      |
